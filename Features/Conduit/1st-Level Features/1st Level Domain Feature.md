...
level: 1
scc:
- mcdm.heroes.v1:feature.trait.conduit.1st-level-feature:1st-level-domain-feature
scdc:
- 1.1.1:11.1.8.1:01
...
effects:
  - effect: >-
      ...
      shown on the 1st-Level Conduit Domain Features table. Additionally, you
      gain a skill from the chosen domain, selected from the skill group
      indicated on the table. (*Quick Build:* Revitalizing Ritual and the Heal
      skill from the Life domain.)
      ...
      for the purpose of understanding the project source for any research or
      crafting project (see Chapter 12: Downtime Projects).
  ...
  - effect: >-
      ...
      uses a skill you have from the intrigue skill group, you can use Intuition
