...
level: 1
scc:
- mcdm.heroes.v1:subfeature.trait.conduit.1st-level-feature:oracular-visions
scdc:
- 1.1.1:12.1.8.3:11
...
metadata:
  ...
  type: subfeature/trait/conduit/1st-level-feature
effects:
  - effect: Your deity rewards you with hazy visions of things to come. Each time
      you earn 1 or more Victories, you earn an equal number of fate points.
