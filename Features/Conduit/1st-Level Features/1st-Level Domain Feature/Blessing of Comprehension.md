...
level: 1
scc:
- mcdm.heroes.v1:subfeature.trait.conduit.1st-level-feature:blessing-of-comprehension
scdc:
- 1.1.1:12.1.8.3:09
...
metadata:
  ...
  type: subfeature/trait/conduit/1st-level-feature
effects:
  - effect: "You can interpret diagrams and charts even if you don't understand the
