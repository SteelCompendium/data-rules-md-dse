...
level: 1
scc:
- mcdm.heroes.v1:feature.subtrait.conduit.1st-level-feature:sanctified-weapon
scdc:
- 1.1.1:11.2.8.3:10
...
metadata:
  ...
  type: feature/subtrait/conduit/1st-level-feature
effects:
  - effect: As a respite activity, you can bless a weapon. Any creature who wields
      the weapon gains a +1 bonus to rolled damage with abilities that use the
